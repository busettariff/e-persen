...
<tr>
    ...
    <td>{!! $d->jam_out ==! null? $d->jam_out : '<span class="badge bg-danger text-black">Belum Absen</span>' !!}</td>
    <td>
        @if($d->jam_out ==! null)
    ...
    <td>
        ...
        @endphp
            <span class="badge bg-danger text-black">Terlambat {{ $jamterlambat }}</span>
        @else
            <span class="badge bg-success text-black">Tepat Waktu</span>
        @endif
    </td>
    <td>
