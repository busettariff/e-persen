<form action="/pegawai/{{ $user->username }}/update" method="POST" id="form-pegawai" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $user->username }}" class="form-control" id="username" name="username" placeholder="NUPTK" readonly>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $user->nama_lengkap }}" class="form-control" id="nama_lengkap" name="nama_lengkap"
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $user->jabatan }}" class="form-control" id="jabatan" name="jabatan" placeholder="Jabatan">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $user->alamat }}" class="form-control" id="alamat" name="alamat" placeholder="Alamat">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                <span class="input-icon-addon">
                    <!-- Download SVG icon from http://tabler-icons.io/i/user -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-phone-call" width="24"
                        height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                        <path
                ...
                <input type="text" value="{{ $user->no_hp }}" class="form-control" id="no_hp" name="no_hp" placeholder="No Handphone">
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-12">
            <div class="input-icon mb-3 blur-effect">
                ...
                <select name="kode_mapel" id="kode_mapel" class="form-control">
                    ...
                    @foreach ($mapel as $d)
                    <option value="{{ $d->kode_mapel }}" {{ $user->kode_mapel === $d->kode_mapel ? 'selected' : '' }}>
                        {{ $d->nama_mapel }}
                    </option>
                    @endforeach
                </select>
